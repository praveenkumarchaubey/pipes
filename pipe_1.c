/* Write a program where the parent process writes in the pipe and child process reads from the pipe continuously.
 * To send data to the child the parent takes it from the user.
 * When parent process receives the string “exit” from the user, it sends “exit” on the pipe, closes the write end of the pipe and exits.
 * Upon receiving “exit”, the client (child) terminates.*/
